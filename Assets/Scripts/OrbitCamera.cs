...
public abstract class OrbitCamera : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("The panning speed")]
    protected float panSpeed = 0.02f;
    ...
    #region accessors
    public Transform SetCentre { set { centre = value; } }
    ...
    public void SetCentreObject(GameObject inObject)
    {
        centre = inObject.transform;
        ResetOffset();
    }

    public void ToggleWireframe(bool newWireframe)
    {
        GL.wireframe = newWireframe;
        Debug.Log("Setting Wireframe!");
    }
}
